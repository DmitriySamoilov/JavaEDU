package HomeTasks1;/*+Задано уравнение вида q + w = e, q, w, e >= 0. Некоторые цифры могут быть заменены знаком вопроса,
...
public class Task5 {
    public static void main(String[] args) {
        ...
        if ((e - (q*10+a)>=w) && ((e - (q*10+a)) <100 )) System.out.printf("%d%d + %d = %d \n", q, a,(e - (q*10+a)), e);
