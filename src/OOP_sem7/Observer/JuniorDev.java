...
public class JuniorDev implements Observer {
    ...
    public JuniorDev(String name) {
        this.name = name;
        this.minSalary = random.nextDouble(35000, 60000);
        this.needJob = true;
    }
